...
struct ProfileView: View {
    ...
    @AppStorage("sahaay.notifications-enabled") private var notificationsEnabled = true
    @AppStorage("sahaay.demo-mode") private var demoMode = false
    ...
    private var settingsSection: some View { VStack(alignment: .leading, spacing: 10) { Text("Settings").font(AppTheme.Font.title3); VStack(spacing: 0) {
        ...
        Toggle(isOn: $demoMode) { Label("Demo Mode", systemImage: "testtube.2") }.padding(16); Divider().padding(.horizontal, 16)
